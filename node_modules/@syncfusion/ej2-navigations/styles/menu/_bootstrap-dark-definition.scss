...
$menu-seperator-border-color: $grey-44 !default;
$menu-ul-border: $menu-li-border-width $menu-li-border-style $grey-44 !default;
...
$menu-caret-font-size: 11px !default;
$menu-caret-right: 6px !default;
...
$menu-bigger-li-height: 52px !default;
...
$menu-bigger-caret-font-size: 15px !default;
...
$menu-ul-bgcolor: $grey-darker !default;
$menu-li-border-color: $grey-44 !default;
$menu-color: $cmenu-color !default;
$menu-li-bgcolor: $grey !default;
...
$menu-li-selection-bgcolor: $grey !default;
...
$menu-icon-hover-color: inherit !default;
